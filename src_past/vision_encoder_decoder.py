...
class SmallCap(PreTrainedModel):
    ...
    def __init__(
        ...
        self.encoder_vision = encoder.vision_model
        self.encoder_vision.main_input_name = 'pixel_values'
        self.encoder_text = encoder.text_model
        self.encoder_text.main_input_name = 'prompt'
        self.decoder = decoder
        # make sure that the individual model's config refers to the shared config
        # so that the updates to the config will be synced
        self.encoder_vision.config = self.config.encoder
        self.encoder_text.config = self.config.encoder
        self.decoder.config = self.config.decoder

    def get_encoder_vision(self):
        return self.encoder_vision

    def get_encoder_text(self):
        return self.encoder_text
    ...
    def forward(
        ...
        **kwargs,
        ...
        if encoder_outputs is None:
            ...
            encoder_outputs = self.encoder_vision(
